    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/schedule-weeks/scaffold").hasRole("MANAGER")
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/schedule-weeks/*/publish").hasRole("MANAGER")
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/schedule-weeks/*/open").hasRole("MANAGER")
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/shifts").hasRole("MANAGER")
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/shifts/*").hasRole("MANAGER")
